...
This repository shows how to derive semantic representations of words for use in natural language processing 
...
3. Install PyTorch and torchvision; this should install the latest version of PyTorch.
  ...
  - __Linux__ or __Mac__: 
  ```
  conda install pytorch torchvision -c pytorch (for CPU only)
  conda install pytorch torchvision cudatoolkit=9.0 -c pytorch (with GPU)
  ```
  - __Windows__: 
  ```
